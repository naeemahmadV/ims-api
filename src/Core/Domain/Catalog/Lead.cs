...
public class Lead : AuditableEntity, IAggregateRoot
{
    ...
    public IList<SalesCoordinator>? SalesCoordinators { get; set; }
    public IList<TechnicalCoordinator>? TechnicalCoordinators { get; set; }
    public IList<LeadMedia>? LeadMedias { get; set; }
    ...
    public Lead(string? topic, string? firstName, string? lastName, string? email, string? businessPhone, string? mobilePhone, string? jobDescription, Guid? countryId, Guid? stateId, Guid? cityId, string? timeZone, Guid? leadSourceId, string? leadStatus, bool freeTrialOffered, string? prefferedShift, int numberOfResources, DateTime? expectedStartDate, string? domainORIndustry, int budget, int rating, string? leadType, bool nDAShared, DateTime? nDASharedOn, string? technicalCoordinatorStatus, string? website, string? designation, string? company, string? companyAddress1, string? companyAddress2, string? companyPostalCode, string? companyAnnualRevenue, int? companyNumberofEmployees, int? preferredContactMethod, bool? followEmail, bool? doNotEmail, bool? doNotBulkEmail, bool? doNotPhone, bool? markAsQualified, DateTime? qualifiedOn, Guid qualifiedBy)
    {
        Topic = topic;
        FirstName = firstName;
        LastName = lastName;
        ...
        MarkAsQualified = markAsQualified;
        QualifiedOn = qualifiedOn;
        QualifiedBy = qualifiedBy;
    }

    public Lead Update(string? topic, string? firstName, string? lastName, string? email, string? businessPhone, string? mobilePhone, string? jobDescription, Guid? countryId, Guid? stateId, Guid? cityId, string? timeZone, Guid? leadSourceId, string? leadStatus, bool freeTrialOffered, string? prefferedShift, int numberOfResources, DateTime? expectedStartDate, string? domainORIndustry, int budget, int rating, string? leadType, bool nDAShared, DateTime? nDASharedOn, string? technicalCoordinatorStatus, string? website, string? designation, string? company, string? companyAddress1, string? companyAddress2, string? companyPostalCode, string? companyAnnualRevenue, int? companyNumberofEmployees, int? preferredContactMethod, bool? followEmail, bool? doNotEmail, bool? doNotBulkEmail, bool? doNotPhone, bool? markAsQualified, DateTime? qualifiedOn, Guid qualifiedBy)
    {
        ...
        if (LeadSourceId.Equals(leadSourceId) is not true) LeadSourceId = leadSourceId;
        ...
        if (leadType is not null && LeadType?.Equals(leadType) is not true) LeadType = leadType;
        ...
        if (markAsQualified is not null)MarkAsQualified = markAsQualified;
        if (qualifiedOn is not null && QualifiedOn?.Equals(qualifiedOn) is not true) QualifiedOn = qualifiedOn;
        if (QualifiedBy.Equals(qualifiedBy) is not true) QualifiedBy = qualifiedBy;
