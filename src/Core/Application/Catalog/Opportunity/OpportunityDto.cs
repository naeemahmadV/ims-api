...
public class OpportunityDto : IDto
{
    ...
    public string? OpportunitySourceSourceName { get; set; } = default!;

    public string? OpportunityStatus { get; set; }
    public IList<OpportunitySkillDto>? OpportunitySkills { get; set; }
    public IList<OpportunitySubSkillDto>? OpportunitySubSkills { get; set; }
    public IList<OpportunitySalesCoordinatorDto>? SalesCoordinators { get; set; }
    public IList<OpportunityTechnicalCoordinatorDto>? TechnicalCoordinators { get; set; }
    public IList<OpportunityMediaDto>? OpportunityMedias { get; set; }
...
public class OpportunitySkillDto : IDto
{
...
public class OpportunitySubSkillDto : IDto
{
    public Guid OpportunityId { get; set; }
...
public class OpportunitySalesCoordinatorDto : IDto
{
    public Guid OpportunityId { get; set; }
...
public class OpportunityTechnicalCoordinatorDto : IDto
{
    public Guid OpportunityId { get; set; }
    public Guid? UserId { get; set; }
}

public class OpportunityMediaDto : IDto
{
    public Guid OpportunityId { get; set; }
